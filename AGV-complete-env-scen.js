...
// Connection: Attach
class Attach extends Connection {
  constructor(name = 'Attach', opts = {}) {
    super(name, {
      ...opts,
      connectionType: 'connection',
      from: 'Vehicle.arm',
...
class MyFactory extends EnvironmentDefinition {
  constructor() {
    ...
    this.registerConnectionClass('Attach', Attach);
    ...
    this.AGV1Events = {
      ...
      rules: [
        ...
        },
        {
          ...
          execute: (context) => {
            if (context.sysadlBase && context.sysadlBase.logger) context.sysadlBase.logger.log('⚡ Executing AGV1Events: AGV1attachPartX -> AGV1NotifLoad');
            const results = [];
            const currentRule = this.AGV1Events.rules.find(r => r.trigger === 'AGV1attachPartX');
    ...
    this.AGV2Events = {
      ...
      rules: [
        ...
        },
        {
          ...
          execute: (context) => {
            if (context.sysadlBase && context.sysadlBase.logger) context.sysadlBase.logger.log('⚡ Executing AGV2Events: AGV2attachPartX -> AGV2NotifLoad');
            const results = [];
            const currentRule = this.AGV2Events.rules.find(r => r.trigger === 'AGV2attachPartX');
      ...
      rules: [
        {
          ...
          tasks: {
            AGV1attachPartX: (context) => {
              // Connection: Attach(agv1, part)
              if (context.sysadlBase && context.sysadlBase.helpers) {
                context.sysadlBase.helpers.executeConnection('Attach', 'agv1', 'part');
              }
              return true;
            },
          },
          execute: (context) => {
            if (context.sysadlBase && context.sysadlBase.logger) context.sysadlBase.logger.log('⚡ Executing PartXEvents: cmdAGV1loadA -> AGV1attachPartX');
            const results = [];
            const currentRule = this.PartXEvents.rules.find(r => r.trigger === 'cmdAGV1loadA');
            results.push(currentRule.tasks.AGV1attachPartX(context));
            return results;
          }
        },
        {
        ...
        },
        {
          ...
          tasks: {
            AGV2attachPartX: (context) => {
              // Connection: Attach(agv2, part)
              if (context.sysadlBase && context.sysadlBase.helpers) {
                context.sysadlBase.helpers.executeConnection('Attach', 'agv2', 'part');
              }
              return true;
            },
          },
          execute: (context) => {
            if (context.sysadlBase && context.sysadlBase.logger) context.sysadlBase.logger.log('⚡ Executing PartXEvents: cmdAGV2loadC -> AGV2attachPartX');
            const results = [];
            const currentRule = this.PartXEvents.rules.find(r => r.trigger === 'cmdAGV2loadC');
            results.push(currentRule.tasks.AGV2attachPartX(context));
            return results;
          }
        },
        {
